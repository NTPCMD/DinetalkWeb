...
export function HomePage({ onNavigate }: HomePageProps) {
  ...
  const features = [
    {
      icon: (
        <div className="draw-icon" data-reveal-icon>
  ...
  return (
    <div className="min-h-screen">
      <section
        ...
        style={{
          backgroundImage:
            "url('https://images.unsplash.com/photo-1758216169108-d1b62d114582?crop=entropy&cs=tinysrgb&fit=max&fm=webp&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxyZXN0YXVyYW50JTIwcGhvbmUlMjBjYWxsfGVufDF8fHx8MTc2MTE4MjczNHww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral')",
        }}
      >
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-4xl md:text-5xl mb-6 leading-relaxed md:leading-loose hero-heading hero-text">
                <span className="sr-only">We take your calls, so you can focus on the food.</span>
                {typed}
              </h1>
              <p
                className={`text-xl mb-8 text-foreground/90 ${showTagline ? 'in-view' : 'title-fade'} hero-text`}
              >
            ...
            <div className="rounded-2xl overflow-hidden shadow-xl md:bg-transparent relative">
              <ImageWithFallback
      ...
      <section className="py-20 bg-background" data-reveal>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground">Built for restaurants, cafés, and takeaways</p>
          </div>
          ...
          <Card className="bg-card border-0">
            <CardContent className="p-8">
              <p className="text-xl mb-6 italic">
                “DineTalk has been a game-changer for our restaurant. We never miss a booking anymore, and our staff can focus on
                what they do best — serving great food.”
              </p>
